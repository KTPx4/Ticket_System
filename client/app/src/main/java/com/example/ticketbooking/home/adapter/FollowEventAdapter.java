...
public class FollowEventAdapter extends RecyclerView.Adapter<FollowEventAdapter.FollowEventViewHolder>{
    ...
    @Override
    public FollowEventAdapter.FollowEventViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_follow_event, parent, false);
        return new FollowEventAdapter.FollowEventViewHolder(view);
    }

    @Override
    public void onBindViewHolder(FollowEventAdapter.FollowEventViewHolder holder, int position) {
